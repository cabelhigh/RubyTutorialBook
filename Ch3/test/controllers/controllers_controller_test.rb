...
class ControllersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create controller" do
    assert_difference('Controller.count') do
      post controllers_url, params: { controller: { StaticPages: @controller.StaticPages, help: @controller.help, home: @controller.home } }
    end
  ...
  test "should update controller" do
    patch controller_url(@controller), params: { controller: { StaticPages: @controller.StaticPages, help: @controller.help, home: @controller.home } }
